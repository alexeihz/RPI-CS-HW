...
void StudentTests(){
	 ...
	 */
	std::cout << std::endl;
	Rope r1(IndexTestRope2());
	std::string s1 = "Hello my name is Simon oof";
	std::string rs1;
	...
	//Concat test
	Rope r2(IndexTestRope2());
	Rope r3(ConcatTestRopeRight());
	std::string s2 = "Hello my name is Simon oof";
	...
	//Split test
	Rope r4(IndexTestRope()); //Wikipedia split @ 12
	std::string s4 = "Hello my name is Simon";
	Rope r5;
	std::string s5 = s4.substr(0,12);
	std::string s6 = s4.substr(12,12);
	r4.split(12,r5);
	...
	Rope r11;
	r11 = r10;
	assert(r11.expose_root() != r10.expose_root());
 	assert(r11.size() == r10.size());
	assert(r11.report(0,r11.size()-1,rs1) && r10.report(0,r9.size()-1,rs2) && rs1 == rs2);
