...
void StudentTests() {
  ...
  // create a table with dimensions 3x3, where all entries are '.'
  Table<int> t(3,3,0);
  assert (t.get(0,0) == 0);
  assert (t.get(1,0) == 0);
  assert (t.get(1,1) == 0);
  ...
  t.pop_back_column();
  assert (t.numRows() == 4);
  assert (t.numColumns() == 2);
  //invald if you uncomment 2 or 3 lines below
  //t.pop_back_column();
  //t.pop_back_column();
  //t.pop_back_column();
  t.print();
  ...
  new_col.push_back(9);
  new_col.push_back(10);
  new_col.push_back(11);
  new_col.push_back(12);
  //invalid
  //new_col.push_back(12);
  t.push_back_column(new_col);
  assert (t.numRows() == 4);
  ...
  assert (t.numRows() ==3);
  assert (t.numColumns() == 3);
  //invald if you uncomment 2 - 4 lines below
  //t.pop_back_row();
  //t.pop_back_row();
  //t.pop_back_row();
  //t.pop_back_row();
