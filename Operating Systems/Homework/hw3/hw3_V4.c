...
struct ez_Struct ez_struct_1[20000000];
//struct ez_Struct *ez_struct_1 = calloc(sizeof(struct ez_Struct), 1);
        ...
        if(threads_needed > 0){
            ...
            if(Scount < rows * cols){
                ...
                if(Scount >= space_limit){
                    ...
                    {
                    if(dead >= 8){
                        dead_end_boards = realloc(dead_end_boards,sizeof(char**)*200000000);
                        // dead_end_boards = realloc(dead_end_boards,sizeof(char**));
                    }
