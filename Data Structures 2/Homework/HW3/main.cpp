...
void additional_student_tests() {
  ...
  std::cout << "additional_student_tests()" << std::endl;
	  ...
	  std::cout << "start with a board of width 9 and a couple pieces:" << std::endl;
	  Tetris tetris(15);
	  tetris.add_piece('I',90,1);
	  tetris.add_piece('O',0,0);
	  tetris.add_piece('I',0,3);
	  tetris.add_piece('I',90,3);
	  tetris.add_piece('0',180,5);
	  tetris.add_piece('I',270,7);
	  tetris.add_piece('0',90,1);
	  tetris.print();
	  ...
	  tetris.add_piece('O',0,1);
	  tetris.add_piece('0',180,5);
	  tetris.add_piece('I',270,8);
	  tetris.add_piece('0',90,1);
	  tetris.add_piece('0',180,5);
	  tetris.add_piece('I',270,4);
	  tetris.add_piece('0',90,1);
