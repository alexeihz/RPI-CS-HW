...
void StudentTest(){
	Matrix array1(7,2,1);
	Matrix array2(4,5,9);
	Matrix array3(array2);
	std::cout << "First Matrix"<< std::endl  << array1 << std::endl;
	std::cout << "Second Matrix"<< std::endl  << array2 << std::endl;
	std::cout << "Third Matrix"<< std::endl << array3 << std::endl;
	
	array1.set(0,0,66);
	std::cout << "First Matrix after set"<< std::endl << array1 << std::endl;
	
	array2.multiply_by_coefficient(1.5);
	std::cout << "Second Matrix after multiply_by_coefficient"<< std::endl << array2 << std::endl;
	
	array1.swap_row(0,1);
	std::cout << "First Matrix after swap_row"<< std::endl << array1 << std::endl;
	
	array1.transpose();
	std::cout << "First Matrix after transpose"<< std::endl << array1 << std::endl;
	
	array1.transpose();
	std::cout << "First Matrix after transpose"<< std::endl << array1 << std::endl;
	
	array2.add(array3);
	std::cout << "Second Matrix after add"<< std::endl << array2 << std::endl;
	
	array3.subtract(array2);
	std::cout << "Third Matrix after subtract"<< std::endl << array3 << std::endl;
}

//Write this if you write resize()
void ExtraCreditTest(){
	Matrix array1(4,5,9);
	Matrix array2(array1);
	array1.resize(3,2,999);
	std::cout << "First Matrix after resize"<< std::endl << array1 << std::endl;
	
	array2.resize(7,2,999);
	std::cout << "Second Matrix after resize"<< std::endl << array2 << std::endl;
